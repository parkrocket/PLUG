      ...
      <div className="head_header">
        <div className="header_bg">
          <div className="search_bar_wrap">
            <div className="h_top_wrap">
              ...
              <form name="fsearchbox" method="get" action="#!">
                ...
                <label htmlFor="sch_stx" className="sound_only">
                  검색어 필수
                </label>
                <input
                  type="search"
                  name="stx"
                  id="sch_stx"
                  placeholder="찾으시는 스포츠가 있으신가요?"
                />
                <button type="submit" id="sch_submit">
                  <img src={searchIcon} alt="검색" />
                </button>
                <button type="reset" className="s_close">
                  취소
                </button>
              </form>
            </div>
          ...
          <div className="more">
            ...
            <ul>
              <li className="on">
                <a href="#!" data="" className="change_ud">
                  <img src="" alt="" />
                  <p></p>
                </a>
...
=======
              <li>
                <Link to="/registerform">회원가입</Link>
              </li>
              <li>

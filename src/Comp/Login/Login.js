            ...
            <form onSubmit={submitHandler}>
                <div className='login_wrap'>
                    ...
                    <div className='input_wrap'>
                        ...
                        <input type='password' name='mb_pass' id='' className='login_box box_2 write_box_style' defaultValue='' onChange={mbPassHandler} placeholder='비밀번호'></input>
                        <input type='submit' value='로그인' className='login_btn'></input>
                        <div className='check_email'>
                            <input type='checkbox' name='auto_login' id='login_auto_login' className='checkbox_com'></input>
                            <label htmlFor='login_auto_login' className='ck_view'></label>
                            <span htmlFor='login_auto_login' className='email_save'>이메일 저장</span>
                        </div>
                        <p className='or'>
